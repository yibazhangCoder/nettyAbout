...
public class PrimaryDatasourceConfig {
     ...
     * dao层的包路径
     */
    static final String PACKAGE = "com.cafebaby.cafewechat.mapper";

    static final String POJO_PACKAGE="com.cafebaby.cafewechat.pojo";
    ...
    public SqlSessionFactory primarySqlSessionFactory(@Qualifier("primaryDataSource") DataSource primaryDataSource) throws Exception {
        ...
        sessionFactory.setMapperLocations(resolver.getResources(PrimaryDatasourceConfig.MAPPER_LOCATION));  // 设置mapper文件路径
        //sessionFactory.setTypeAliasesPackage(PrimaryDatasourceConfig.POJO_PACKAGE);
